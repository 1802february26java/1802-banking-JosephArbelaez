...
public class Database {
	...
	public static double recallBalance(int custID) throws InputException{
	...
	public static void depositTransaction(int custID, double balance ,double newAmount) {
		...
		try(Connection connection = ConnectionUtil.getConnection()){
			...
			logger.error("Error while updating queries Database.withdrawlTransaction");
		}
	}
	...
	public static List<Transaction> selectAll(int custID) {
		logger.trace("Getting all Transactions");
		...
		try(Connection connection = ConnectionUtil.getConnection()){
			...
			logger.error("Error while selecting all Transactions. Database.selectAll().");
		}
		return null;
	}
}
